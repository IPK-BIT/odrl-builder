...
<style global>
    ...
    */
	...
	.btn-secondary {
		background: linear-gradient(0deg, hsl(207, 82%, 45%) 0%, hsl(207, 82%, 60%) 100%) !important;
	}
	.btn-secondary:hover {
		background: linear-gradient(0deg, hsl(207, 82%, 45%) 0%, hsl(207, 82%, 66%) 100%) !important;
	}
</style>
